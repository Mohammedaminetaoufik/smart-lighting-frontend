...
import { X, Zap, Thermometer, Droplets, Eye, Activity, Cpu, Shield, Gauge, Wifi, Clock, AlertTriangle, CheckCircle } from 'lucide-react'
import { LineChart, Line, XAxis, YAxis, Tooltip, ResponsiveContainer, CartesianGrid } from 'recharts'
import toast from 'react-hot-toast'
import { getLatestTelemetry, getTelemetry, getDimmingHistory, setDimming, getDecisions } from '../../api/lampadaires'
...
const TABS = ['Info', 'Contrôleur', 'Télémétrie', 'Dimming', 'Décisions']

export default function LampadaireDetail({ lamp, onClose, onUpdate }) {
  ...
  const [dimValue, setDimValue] = useState(lamp.intensite ?? 60)
  ...
  const handleDim = async () => {
    ...
    try {
      ...
      onUpdate?.({ ...lamp, intensite: dimValue })
    } catch (e) {
